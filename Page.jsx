    ...
    <div>
      ...
      <section id="top" className="wrap hero" style={anchor}>
        ...
        <figure className="figure" style={{ margin: 0 }}>
            ...
            <figcaption>
              <span className="fc-text"><strong>Complex System.</strong> Most AI research focuses on data, models, and decisions. Many credit-scoring challenges arise from the social systems that generate data, shape outcomes, and create feedback loops.</span>
            </figcaption>
          </figure>
      </section>
      ...
      <section id="why" className="section-band section-band--tint" style={anchor}>
        ...
        <div className="gov-grid">
          ...
          <figcaption>
            <span className="fc-text"><strong>Outside the Black Box.</strong> Machine learning is only one layer of a larger complex system. We integrate causal inference, system dynamics, and systems thinking to understand how AI operates in the real world.</span>
          </figcaption>
        </figure>
        </div>
        </div>
