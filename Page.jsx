    ...
    <div>
      ...
      <section id="top" className="wrap hero" style={anchor}>
        ...
        <figure className="figure" style={{ margin: 0 }}>
            ...
            <figcaption>
              <span className="fc-text"><strong>Complex Systems.</strong> Many of the most important challenges in credit scoring arise not from AI models themselves, but from the social systems that generate data, shape outcomes, and create feedback loops.</span>
            </figcaption>
          </figure>
      </section>
