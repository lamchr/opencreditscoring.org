    ...
    <div>
      ...
      <section id="top" className="wrap hero" style={anchor}>
        ...
        <figure className="figure" style={{ margin: 0 }}>
          ...
          <figcaption>
            <span className="fc-text"><strong>Common Foundation.</strong> Causal models enable us to directly translate concepts between antidiscrimination law and machine learning.</span>
          </figcaption>
        </figure>
      </section>
