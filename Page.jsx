    ...
    <div>
      ...
      <section id="top" className="wrap hero" style={anchor}>
        <div>
          ...
          <p className="lead">Open Credit Scoring seeks to establish the scientific foundations for trustworthy credit decisions and foster a more open, competitive, and innovative credit scoring ecosystem.</p>
        </div>
        <figure className="figure" style={{ margin: 0 }}>
            ...
            <figcaption>
              <span className="fc-text"><strong>Complex Systems.</strong> Most AI research is focused on data, models, and decisions. But many AI problems in credit scoring require understanding the social system that generates the data, the consequences of decisions, and their feedback loops.</span>
            </figcaption>
          </figure>
      </section>
