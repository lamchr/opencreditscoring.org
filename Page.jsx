    ...
    <div>
      ...
      <section id="top" className="wrap hero" style={anchor}>
        <div>
          ...
          <p className="lead">As lenders increasingly automate credit decisions with AI, many of the industry's most important challenges—including fairness, validity, and governance—cannot be solved through machine learning alone.</p>
        </div>
        <figure className="figure" style={{ margin: 0 }}>
            ...
            <figcaption>
              <span className="fc-text"><strong>Complex Systems.</strong> While AI research has focused heavily on data, models, and decisions, the broader social systems that generate data, shape consequences, and create feedback loops remain comparatively under-studied.</span>
            </figcaption>
          </figure>
      </section>
          ...
          <div className="gov-grid">
            <div className="person">
              ...
              <div>
                ...
                <div className="role">{team[0].role}</div>
              </div>
            </div>
