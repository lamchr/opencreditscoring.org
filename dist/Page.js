...
function Page({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("section", {
    ...
    className: "fc-text"
  }, /*#__PURE__*/React.createElement("strong", null, "Common Foundation."), " Causal models enable us to directly translate concepts between antidiscrimination law and machine learning.")))), /*#__PURE__*/React.createElement("section", {
    id: "why",
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h2", null, "Why Open Credit Scoring?"))), /*#__PURE__*/React.createElement("div", {
    className: "sec-block"
  }, /*#__PURE__*/React.createElement("div", {
    className: "gov-grid"
    ...
    dangerouslySetInnerHTML: {
      __html: `<svg viewBox="0 0 580 480" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" role="img" aria-label="Feedback loop split into an under-studied top half (Social System, Data Generating Process, Consequences) and a well-studied bottom half (Data, AI Model, Decisions)"><defs><marker id="whyAh" markerWidth="12" markerHeight="12" refX="8.5" refY="5" orient="auto" markerUnits="userSpaceOnUse"><path d="M0,0 L10,5 L0,10 L3.4,5 Z" fill="var(--blue-700)"></path></marker></defs><line x1="-300" y1="240" x2="880" y2="240" stroke="rgba(21,24,30,0.55)" stroke-width="1.3" stroke-dasharray="5 5"></line><text x="290" y="224" text-anchor="middle" font-family="var(--font-mono)" font-size="16" letter-spacing="2" fill="var(--red-600)">UNDER-STUDIED</text><text x="290" y="267" text-anchor="middle" font-family="var(--font-mono)" font-size="16" letter-spacing="2" fill="var(--ink-700)">WELL-STUDIED</text><path d="M334.0 75.8 A 170 170 0 0 1 403.8 113.7" fill="none" stroke="var(--blue-700)" stroke-width="1.8" marker-end="url(#whyAh)"></path><path d="M452.6 190.3 A 170 170 0 0 1 450.7 295.3" fill="none" stroke="var(--blue-700)" stroke-width="1.8" marker-end="url(#whyAh)"></path><path d="M418.3 351.5 A 170 170 0 0 1 331.1 405.0" fill="none" stroke="var(--blue-700)" stroke-width="1.8" marker-end="url(#whyAh)"></path><path d="M248.9 405.0 A 170 170 0 0 1 161.7 351.5" fill="none" stroke="var(--blue-700)" stroke-width="1.8" marker-end="url(#whyAh)"></path><path d="M129.3 295.3 A 170 170 0 0 1 127.4 190.3" fill="none" stroke="var(--blue-700)" stroke-width="1.8" marker-end="url(#whyAh)"></path><path d="M176.2 113.7 A 170 170 0 0 1 246.0 75.8" fill="none" stroke="var(--blue-700)" stroke-width="1.8" marker-end="url(#whyAh)"></path><text x="290.0" y="63.5" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Social</text><text x="290.0" y="90.5" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">System</text><text x="437.2" y="148.5" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Data Generating</text><text x="437.2" y="175.5" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Process</text><text x="437.2" y="332.0" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Data</text><text x="290.0" y="403.5" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">AI</text><text x="290.0" y="430.5" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Model</text><text x="142.8" y="332.0" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Decisions</text><text x="142.8" y="162.0" text-anchor="middle" font-family="var(--font-serif)" font-size="22" fill="var(--ink-900)">Consequences</text></svg>`
    }
  }), /*#__PURE__*/React.createElement("figcaption", null, /*#__PURE__*/React.createElement("span", {
    className: "fc-text"
  }, /*#__PURE__*/React.createElement("strong", null, "Complex Systems."), " Traditional AI research has focused primarily on data, models, and decisions. The scope needs to include the social system that generates the data, the consequences of decisions, and the feedback loops that connect them over time."))))))), /*#__PURE__*/React.createElement("section", {
    id: "research",
    className: "wrap section",
    style: anchor
  }, /*#__PURE__*/React.createElement("div", {
